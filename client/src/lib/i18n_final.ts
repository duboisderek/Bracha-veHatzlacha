export const translations = {
  en: {
    ...
    winningNotification: "Congratulations! You won ₪{amount}",
    claimInstructions: "Contact support to claim your prize",
    ...
    referralBonus: "Referral Bonus: ₪100",
    bonusCondition: "When friend tops up ₪1000+",
    copyLink: "Copy Link",
    ...
    clientLoginWelcome: "Welcome to BrachaVeHatzlacha",
    ...
    adminLoginWelcome: "Administrative Access",
    adminLoginDescription: "Access restricted to administrators",
    ...
    date: "Date",
    selectWinningNumbers: "Select Winning Numbers",
    ...
    selectDrawDate: "Select draw date",
    createNewDraw: "Create New Draw",
    creating: "Creating",
    createDraw: "Create Draw",
    platformRevenue: "Platform Revenue",
    retentionFromDraw: "Retention from draw",
  ...
  he: {
    ...
    contactChat: "צ'אט חי",
    whatsapp_support: "תמיכה בווטסאפ",
    whatsapp_support_tooltip: "צור קשר איתנו בווטסאפ",
    whatsapp_default_message: "שלום! אני זקוק לעזרה עם האתר ברכה והצלחה",
    ...
    depositSuccess: "הפקדה הושלמה בהצלחה",
    userBlocked: "משתמש נחסם בהצלחה",
    userUnblocked: "חסימת משתמש בוטלה בהצלחה",
    errorLoading: "שגיאה בטעינה",
    errorCreating: "שגיאה ביצירת משתמש",
    errorDeposit: "שגיאה בעיבוד הפקדה",
    errorBlocking: "שגיאה בחסימת משתמש",
    errorDraw: "שגיאה בהפעלת הגרלה",
    ...
    // User Status Levels Hebrew
    userLevel: "רמת משתמש",
    levelProgress: "התקדמות ברמה",
    nextLevelRequirement: "דרישת הרמה הבאה",
    
    // Previous Numbers History Hebrew
    previousDrawNumbers: "מספרי הגרלות קודמות",
    usePreviousDrawNumbers: "השתמש במספרים קודמים",
    selectFromDrawHistory: "בחר מהיסטוריית הגרלות",
    drawHistoryList: "רשימת היסטוריית הגרלות",
    pastWinningNumbers: "מספרים זוכים מהעבר",
    
    // Contact Widgets Hebrew
    quickContactWidget: "יצירת קשר מהיר",
    whatsappContact: "ווטסאפ",
    telegramContact: "טלגרם",
    liveChatContact: "צ'אט חי",
    
    // Draw Lock System Hebrew
    drawLockWarning: "ההגרלה מתחילה בקרוב",
    lockMessage: "השתתפות נחסמה 60 שניות לפני ההגרלה",
    remainingTime: "זמן נותר",
    
    // Notification System Hebrew
    notificationSettings: "הגדרות התראות",
    drawStartNotification: "ההגרלה מתחילה בקרוב!",
    winningNotificationText: "מזל טוב! זכית",
    prizeClaimInstruction: "אסוף את הפרס שלך",
    
    // Referral Features Hebrew
    referralSystem: "מערכת הפניות",
    myReferralCode: "קוד ההפניה שלי",
    ...
    revenue: "הכנסות",
    ticketSales: "מכירת כרטיסים",
    totalWinners: "סך הזוכים",
    ...
    platformRetention: "החזקת פלטפורמה",
    user: "משתמש",
    ...
    retentionFromDraw: "החזקה מהגרלה",
    depositSuccessful: "הפקדה מוצלחת",
    ...
    criticalSettings: "הגדרות קריטיות",
    
    // RÔLE ADMIN STANDARD (מנהל רגיל)
    ...
    // RÔLE CLIENT STANDARD (לקוח רגיל)
    ...
    // Actions et boutons (suppression des doublons)
    ...
    // ===== MENUS ET NAVIGATION PAR RÔLE =====
    
    // MENU ROOT ADMIN (תפריט מנהל עליון)
    systemOverview: "סקירת מערכת",
    userRoles: "תפקידי משתמשים",
    permissions: "הרשאות",
    auditLogs: "לוגי ביקורת",
    systemConfig: "תצורת מערכת",
    integrations: "אינטגרציות",
    apiManagement: "ניהול API",
    webhooks: "Webhooks",
    scheduledTasks: "משימות מתוזמנות",
    monitoringDashboard: "לוח מעקב",
    alertsManagement: "ניהול התראות",
    performanceTuning: "כוונון ביצועים",
    
    // MENU ADMIN STANDARD (תפריט מנהל רגיל)
    clientOverview: "סקירת לקוחות",
    ticketManagement: "ניהול כרטיסים",
    drawSchedule: "לוח הגרלות",
    paymentProcessing: "עיבוד תשלומים",
    customerSupport: "שירות לקוחות",
    reportingCenter: "מרכז דיווח",
    contentManagement: "ניהול תוכן",
    promotionsManagement: "ניהול מבצעים",
    notificationCenter: "מרכז התראות",
    moderationTools: "כלי מודרציה",
    
    // MENU CLIENT VIP (תפריט לקוח VIP)
    vipDashboard: "לוח VIP",
    exclusiveGames: "משחקים בלעדיים",
    vipOffers: "הצעות VIP",
    priorityWithdrawals: "משיכות מועדפות",
    personalManager: "מנהל אישי",
    vipEvents: "אירועי VIP",
    premiumSupport: "תמיכה פרימיום",
    advancedStats: "סטטיסטיקות מתקדמות",
    customLimits: "מגבלות מותאמות",
    
    // MENU CLIENT STANDARD (תפריט לקוח רגיל)
    myDashboard: "הלוח שלי",
    playGames: "משחקים",
    myTransactions: "העסקאות שלי",
    accountSettingsMenu: "הגדרות חשבון",
    helpCenterMenu: "מרכז עזרה",
    contactSupport: "צור קשר עם תמיכה",
    promotions: "מבצעים",
    gameHistory: "היסטוריית משחקים",
    
    // MENU NOUVEAU CLIENT (תפריט לקוח חדש)
    welcomeDashboard: "לוח ברוכים הבאים",
    ...
    // PROCESSUS D'INSCRIPTION (תהליך הרשמה)
    registrationProcess: "תהליך הרשמה",
    personalInfo: "מידע אישי",
    contactInfo: "פרטי קשר",
    accountVerification: "אימות חשבון",
    termsAcceptance: "קבלת תנאים",
    welcomeEmail: "אימייל ברוכים הבאים",
    accountActivation: "הפעלת חשבון",
    
    // PROCESSUS DE VÉRIFICATION (תהליך אימות)
    verificationWorkflow: "תהליך אימות",
    identityVerification: "אימות זהות",
    documentUpload: "העלאת מסמכים",
    manualReview: "בדיקה ידנית",
    autoVerification: "אימות אוטומטי",
    verificationStatus: "סטטוס אימות",
    rejectionReason: "סיבת דחייה",
    resubmission: "הגשה מחדש",
    
    // PROCESSUS DE PAIEMENT (תהליך תשלום)
    paymentProcess: "תהליך תשלום",
    paymentMethods: "שיטות תשלום",
    cardPayment: "תשלום בכרטיס",
    bankTransfer: "העברה בנקאית",
    digitalWallet: "ארנק דיגיטלי",
    paymentSecurity: "אבטחת תשלום",
    fraudPrevention: "מניעת הונאה",
    chargebackProtection: "הגנת חזרה",
    
    // PROCESSUS DE RETRAIT (תהליך משיכה)
    withdrawalProcess: "תהליך משיכה",
    withdrawalMethods: "שיטות משיכה",
    minimumWithdrawal: "משיכה מינימלית",
    maximumWithdrawal: "משיכה מקסימלית",
    withdrawalFees: "עמלות משיכה",
    processingTime: "זמן עיבוד",
    withdrawalHistory: "היסטוריית משיכות",
    pendingWithdrawals: "משיכות ממתינות",
    
    // ===== STATUTS ET ÉTATS =====
    
    // STATUTS UTILISATEUR (סטטוסי משתמש)
    userStatuses: "סטטוסי משתמש",
    activeStatus: "סטטוס פעיל",
    inactiveStatus: "סטטוס לא פעיל",
    suspendedStatus: "סטטוס מושעה",
    bannedStatus: "סטטוס חסום",
    verifiedStatus: "סטטוס מאומת",
    unverifiedStatus: "סטטוס לא מאומת",
    vipStatus: "סטטוס VIP",
    premiumStatus: "סטטוס פרימיום",
    
    // ÉTATS DES TRANSACTIONS (מצבי עסקאות)
    transactionStates: "מצבי עסקאות",
    pendingTransaction: "עסקה ממתינה",
    completedTransaction: "עסקה הושלמה",
    failedTransaction: "עסקה נכשלה",
    cancelledTransaction: "עסקה בוטלה",
    processingTransaction: "עסקה מעובדת",
    refundedTransaction: "עסקה הוחזרה",
    
    // ÉTATS DES TIRAGES (מצבי הגרלות)
    drawStates: "מצבי הגרלות",
    upcomingDraw: "הגרלה קרובה",
    activeDraw: "הגרלה פעילה",
    lockedDraw: "הגרלה נעולה",
    completedDraw: "הגרלה הושלמה",
    cancelledDraw: "הגרלה בוטלה",
    
    // ===== NOTIFICATIONS ET ALERTES =====
    
    // TYPES DE NOTIFICATIONS (סוגי התראות)
    notificationTypes: "סוגי התראות",
    systemNotifications: "התראות מערכת",
    paymentNotifications: "התראות תשלום",
    gameNotifications: "התראות משחק",
    securityNotifications: "התראות אבטחה",
    promotionalNotifications: "התראות פרסומיות",
    urgentNotifications: "התראות דחופות",
    infoNotifications: "התראות מידע",
    warningNotifications: "התראות אזהרה",
    
    // CANAUX DE NOTIFICATION (ערוצי התראה)
    notificationChannels: "ערוצי התראה",
    ...
    whatsappNotifications: "התראות ווטסאפ",
    telegramNotifications: "התראות טלגרם",
    
    // ===== PARAMÈTRES ET CONFIGURATION =====
    
    // PARAMÈTRES GÉNÉRAUX (הגדרות כלליות)
    generalSettings: "הגדרות כלליות",
    languageSettings: "הגדרות שפה",
    timezoneSettings: "הגדרות איזור זמן",
    ...
    // PARAMÈTRES DE SÉCURITÉ (הגדרות אבטחה)
    securityConfiguration: "תצורת אבטחה",
    passwordPolicy: "מדיניות סיסמאות",
    sessionTimeout: "פסק זמן הפעלה",
    ipRestrictions: "הגבלות IP",
    deviceManagement: "ניהול מכשירים",
    loginAttempts: "ניסיונות התחברות",
    accountLockout: "נעילת חשבון",
    securityQuestions: "שאלות אבטחה",
    
    // PARAMÈTRES DE JEU (הגדרות משחק)
    gameSettings: "הגדרות משחק",
    betLimits: "מגבלות הימור",
    playTime: "זמן משחק",
    responsibleGaming: "משחק אחראי",
    selfExclusion: "הרחקה עצמית",
    cooloffPeriod: "תקופת הפוגה",
    realityCheck: "בדיקת מציאות",
    spendingLimits: "מגבלות הוצאה",
    
    // ===== AIDE ET SUPPORT =====
    
    // CENTRE D'AIDE (מרכז עזרה)
    helpCenterMain: "מרכז עזרה",
    faqSection: "מדור שאלות נפוצות",
    tutorials: "מדריכים",
    videoGuides: "מדריכי וידאו",
    stepByStepGuides: "מדריכים שלב אחר שלב",
    troubleshooting: "פתרון בעיות",
    knowledgeBase: "בסיס ידע",
    searchHelp: "חיפוש בעזרה",
    
    // SUPPORT CLIENT (תמיכת לקוחות)
    customerSupportMain: "תמיכת לקוחות",
    liveChatSupport: "תמיכת צ'אט חי",
    emailSupport: "תמיכת אימייל",
    phoneSupport: "תמיכה טלפונית",
    ticketSupport: "תמיכת כרטיסים",
    prioritySupportService: "תמיכה מועדפת",
    supportHours: "שעות תמיכה",
    supportLanguages: "שפות תמיכה",
    
    // TYPES DE DEMANDES (סוגי בקשות)
    requestTypes: "סוגי בקשות",
    technicalSupport: "תמיכה טכנית",
    accountIssues: "בעיות חשבון",
    paymentIssues: "בעיות תשלום",
    gameIssues: "בעיות משחק",
  ...
  fr: {
    ...
    // Admin Dashboard Missing Keys French
    jackpot: "Jackpot",
    prizePool: "Cagnotte",
    revenue: "Revenus",
    ticketSales: "Ventes de Tickets",
    totalWinners: "Total Gagnants",
    submitDrawResults: "Soumettre Résultats du Tirage",
    date: "Date",
    selectWinningNumbers: "Sélectionner Numéros Gagnants",
    winningNumbers: "Numéros Gagnants",
    processing: "En cours",
    submitResults: "Soumettre Résultats",
    drawStatistics: "Statistiques du Tirage",
    ticketsText: "tickets",
    ...
    selectDrawDate: "Sélectionner date du tirage",
    ...
    searchUserByEmail: "Chercher utilisateur par email",

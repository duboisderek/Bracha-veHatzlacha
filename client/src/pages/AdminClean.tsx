...
export default function AdminClean() {
  ...
  const depositMutation = useMutation({
    mutationFn: async ({ userId, amount, comment }: { userId: string; amount: string; comment: string }) => {
      return apiRequest("POST", "/api/admin/manual-deposit", { userId, amount, comment });
    },
    onSuccess: () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="shadow-xl border-0">
            <CardContent className="p-6">
              ...
              <div className="text-3xl font-bold text-slate-900">
                #{(currentDraw as any)?.drawNumber || "N/A"}
              </div>
          ...
          <Card className="shadow-xl border-0">
            <CardContent className="p-6">
              ...
              <div className="text-3xl font-bold text-slate-900">
                ₪{(currentDraw as any)?.jackpotAmount || "0"}
              </div>
        ...
        {/* System Controls and Draw History */}

  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="p-4 bg-blue-50 rounded-lg">
        <h4 className="font-semibold text-blue-900 mb-4">Create New User</h4>
      ...
      {/* Manual Deposit */}
      <div className="p-4 bg-green-50 rounded-lg">
        <h4 className="font-semibold text-green-900 mb-4">Manual Deposit</h4>
        <div className="space-y-3">
          <div>
      ...
      <div className="p-4 bg-red-50 rounded-lg">
        <h4 className="font-semibold text-red-900 mb-4">Block User</h4>
        <div className="space-y-3">
          <div>
